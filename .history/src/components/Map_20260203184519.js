    ...
    try {
      ...
      map.current.on('error', (e) => {
        ...
        if (e.error && e.error.message) {
          ...
          setError('Lỗi khi tải bản đồ. Vui lòng kiểm tra Mapbox token.');
        }
      });
          ...
          new mapboxgl.Popup()
            ...
            .setHTML(`
              <div style="padding: 8px;">
                ...
                <p style="margin: 0; color: #666; font-size: 14px;">${district.type}</p>
              </div>
            `)
            .addTo(map.current);
        }
    ...
    <div className="map-container">
      ...
      <div className="map-legend">
        ...
        <div className="legend-items">
          {districtsData.features.map((feature) => (
            <div key={feature.properties.id} className="legend-item">
              <div
